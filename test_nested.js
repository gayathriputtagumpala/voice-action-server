...
async function test() {
  ...
  const variations = [
    { name: 'Organization Object', body: { "ActionCode": "ASG_CHANGE", "Organization": { "OrganizationId": 300000047013600 } } },
    { name: 'Department Object', body: { "ActionCode": "ASG_CHANGE", "Department": { "DepartmentId": 300000047013600 } } }
  ];
