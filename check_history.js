...
async function test() {
  ...
  try {
    ...
    console.log(JSON.stringify(res.data.items.map(i => ({ 
      assignmentId: i.AssignmentId, 
      startDate: i.EffectiveStartDate, 
      endDate: i.EffectiveEndDate,
